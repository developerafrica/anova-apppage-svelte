...
<section id="layout">
		...
		<div class="nv">
			...
			<div class="options">
				<div class="opt">
					...
					<div on:click={()=>{clip = !clip}} class="menu">
						<div class="mn">
	...
	<div class:clip={clip} class="toogle">
		<div class="tg">
			<div class="content">
				<div class="cnt">		
					<div class="top">
	...
	#layout{
		.navigation{
			...
			.nv{
				...
				.brand{
					h1{
						@include font(var(--dtc), 0.8rem, 500);
						padding: 0px 10px;
						margin: 0;
					}
		...
		//	background: #d7eafb;
			...
			z-index: 8;
			pointer-events: none;
			clip-path: circle(0px at 90%);
			-webkit-clip-path: circle(0px at 90%);
					...
					.cnt{
						...
						.top{
							.tp{
								...
								border-bottom: var(--bc) solid 1px;
								.tp-text{
									padding: 0 0.9375rem;
									h1{
										@include font(var(--wtc), 0.875rem, 500);
